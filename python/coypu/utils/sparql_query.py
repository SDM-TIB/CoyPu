...
def main(client_url='', client_id='', client_secret='', query="""SELECT DISTINCT ?s ?o WHERE{?s a ?o.} LIMIT 10"""):
...
if __name__ == "__main__":
      main(credentials.client_url_tib, credentials.client_id_tib, credentials.client_secret_tib)
